...
{
    #region 1º Criação do Attribute para trabalhar no Client
    ...
    #region 2º Para funcionar no Client (Javascript), é preciso dessas classes abaixo
    ...
    //Para este adapter ser registrado, precisará ser registrado via Injeção de dependencia, no startUp.
    #endregion
